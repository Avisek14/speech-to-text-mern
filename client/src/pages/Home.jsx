  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        {/* Navbar */}
        <div className="flex justify-between items-center mb-12 bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl px-4 py-3 shadow-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={logout}
              className="flex items-center gap-1 text-sm text-gray-400 hover:text-white bg-white/5 hover:bg-red-500/20 border border-white/10 hover:border-red-500/30 px-3 py-1.5 rounded-xl transition-all duration-200"
            >
              <span>🚪</span>
